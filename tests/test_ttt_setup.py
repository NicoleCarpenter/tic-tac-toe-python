...
class TestTTTSetup(unittest.TestCase):
  ...
  def test_setup_game_players_pvc_select_first(self):
    setup_options = [self.player_vs_computer, self.select_order, self.first_player]
  ...
  def test_setup_game_players_pvc_select_second(self):
    setup_options = [self.player_vs_computer, self.select_order, self.second_player]
    self.view.stub_numbered_option_selection(setup_options)
    players = self.setup.setup_game_players()
    ...
    self.assertEquals(self.view.prompt_numbered_options_called, True)
    self.assertEquals(self.view.get_numbered_option_selection_called, True)
    self.assertIsInstance(players[0], ComputerPlayer)
  ...
  def test_setup_game_players_pvc_random(self):
    setup_options = [self.player_vs_computer, self.random_order]
    self.view.stub_numbered_option_selection(setup_options)
    players = self.setup.setup_game_players()
  ...
  def test_setup_game_players_pvp_select_first(self):
    setup_options = [self.player_vs_player, self.select_order, self.first_player]
    self.view.stub_numbered_option_selection(setup_options)
    players = self.setup.setup_game_players()
  ...
  def test_setup_game_players_pvp_select_second(self):
    setup_options = [self.player_vs_player, self.select_order, self.second_player]
    self.view.stub_numbered_option_selection(setup_options)
    players = self.setup.setup_game_players()
  ...
  def test_setup_game_players_pvp_random(self):
    setup_options = [self.player_vs_player, self.random_order]
    self.view.stub_numbered_option_selection(setup_options)
    players = self.setup.setup_game_players()
